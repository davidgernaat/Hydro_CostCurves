...
eta_RD         = 0.7;             %Water to wire efficiency (turbine losses, pipe friction losses)
lifetime    = 40;              %Years
...
P = eta_RD*rho*g*Hgross.*QQ;                 % Capacity based on calculated Q (W)
...
COETotR = COETurR+COEDamR+COEPenR+COEElecR+COEPSR+COEFish+COEMisc+COEPop+COEDis+COELandVal+COEOM+COEOwner+COEQuake+TransCost;
